...
class MatriculaController {
  ...
  static async atualizaMatricula(req, res) {
    ...
    try {
      await matriculasServices.atualizaRegistros(novasInfos, { id: matriculaId, estudante_id: estudanteId })
      const matriculaAtualizada = await matriculasServices.pegaUmRegistro({ id: matriculaId, estudante_id: estudanteId })
